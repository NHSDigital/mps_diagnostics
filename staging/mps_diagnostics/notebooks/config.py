...
# MAGIC %md
# MAGIC This notebook contains parameterised names for columns and tables.
...
DT_MERGE_TEST_TABLE_NAME = 'utils_test_dt_merge_unique'
...
PDS_SCHEMA = {
  ...
  'REPLACED_BY_COL': {
    'NAME': 'replacedBy',
    'KEYS': drop_keys(PDS_KEYS, ['TO_KEY', 'CODE_KEY', 'SED_HIGH_KEY'])
  },
  'REPLACEMENT_OF_COL': {
    'NAME': 'replacementOf',
...
# mps diagnostics columns
MATCHED_NHS_NO_COL = 'MATCHED_NHS_NO'
...
FAMILYNAME_ALGORITHMIC_MATCH_SCORE_COL = 'FAMILYNAME_ALGORITHMIC_MATCH_SCORE'
GIVENNAME_ALGORITHMIC_MATCH_SCORE_COL = 'GIVENNAME_ALGORITHMIC_MATCH_SCORE'
DATEOFBIRTH_ALGORITHMIC_MATCH_SCORE_COL = 'DATEOFBIRTH_ALGORITHMIC_MATCH_SCORE'
GENDER_ALGORITHMIC_MATCH_SCORE_COL = 'GENDER_ALGORITHMIC_MATCH_SCORE'
POSTCODE_ALGORITHMIC_MATCH_SCORE_COL = 'POSTCODE_ALGORITHMIC_MATCH_SCORE'
